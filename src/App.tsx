...
// ============================================================
// SECTION HEADER COMPONENT (محسّن، يبقى فيه أنيميشن خفيف)
// ============================================================
...
// --- Navbar (محسّن، بدون أنيميشن داخلي غير ضروري) ---
...
// ============================================================
// CARD BACK PANEL (بدون أنيميشن داخلي زائد)
// ============================================================
...
// ============================================================
// PACKAGE CARD (يبقى فيه أنيميشن التقليب لأنه ضروري)
// ============================================================
    ...
    <div className="relative w-full h-full" style={{ borderRadius: '1.25rem' }}>
      <AnimatePresence mode="wait" initial={false}>
        {!showBack ? (
          ...
          <CardBackPanel pkg={pkg} details={packageDetails.business} color={color} badge={<Building2 size={20} />} onSelect={handleSelect} onBack={handleHideBack} />
        )}
      </AnimatePresence>
    </div>
  );
...
// ============================================================
// CHANGE PACKAGE MODAL (بدون أنيميشن)
// ============================================================
const ChangePackageModal = memo(({
  ...
  const allPackages = useMemo(() => [...packages, vipPackage, duoPackage, ...equipmentPackages, transportPackage, businessPackage], [packages, vipPackage, duoPackage, equipmentPackages, businessPackage, transportPackage]);
...
// ============================================================
// CarDetailsForm (بدون أنيميشن غير ضروري)
// ============================================================
...
// ============================================================
// PaymentForm (بدون أنيميشن غير ضروري)
// ============================================================
...
function App() {
  ...
  const businessPackage: Package = useMemo(() => ({ id: 'business', name: 'BUSINESS', price: '₪1,499', business: true, features: ['עד 50 רכבים בחודש', 'מנהל לקוח ייעודי', 'דוחות בيعطاءات חודשיים', 'קידום ממומן', 'עיצוב מקצועי לכל מודעה'] }), []);
